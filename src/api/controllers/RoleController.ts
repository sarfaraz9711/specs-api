...
import {
    Post, Body, JsonController, Res, Authorized, Put, Param, QueryParam, Get, Delete, Req, UseBefore
...
export class RoleController {
    ...
    public async createRole(@Body({ validate: true }) createRoleParam: CreateRoleRequest, @Res() response: any, @Req() request : any): Promise<any> {
        ...
        newRoleParams.createdBy = request.id;
        newRoleParams.modifiedByD = request.id;
        //newRoleParams. = slugName;

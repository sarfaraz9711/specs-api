...
export class CustomerCheckoutRequest {
    ...
    public availedProductPromoInfo: any;
    public availedCartBasedPromoInfo: any;
    public availedCouponBasedPromoInfo: any;
    public availedCouponBasedPromoInfoCN: any;
    public totalCartValue: any;
    public paymentStateCode: string;
    public shippingStateCode: string;
    public getLoyaltyPointInfo:any;
    public totalTax:number
    public productsTotalDiscount:number
    public totalItemsPrice:number
    public shippingCharges:number
    public phoneNumberAlter:string
    public creditNoteForOrder:string
    public prepaidOrder:number
    public OrderOffAmount:any
    }

...
export class ProductQuestionController {
     ...
     */
    @Post('/add-question')
    @Authorized(['admin', 'create-product-question'])
    ...
    @Authorized(['admin', 'update-product-question'])
    ...
    @Authorized(['admin', 'update-question-status'])
    ...
    @Authorized(['admin', 'delete-product-question'])
     ...
     */
    @Get('/question-list')
    @Authorized(['admin', 'product-question-list'])

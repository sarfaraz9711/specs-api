...
export class PaymentService {
    ...
    public findPaymentAmount(orderId: any): Promise<any> {
        
       // return this.paymentRepository.findOne(plugins);
       let paymentdata= this.paymentRepository.createQueryBuilder().select('payment_amount')
       .where(" order_id= :order_id", { order_id:orderId  }).execute()
       return paymentdata; 
    }

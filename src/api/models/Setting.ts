...
export class Settings extends BaseModel {
    ...
    @Column({ name: 'category-flag' })
    public categoryFlag: string;

    @Column({ name: 'banner-flag' })
    public bannerFlag: string;

    @Column({ name: 'front-images-flag' })
    public frontImagesFlag: string;

    @Column({ name: 'setting-flag' })
    public settingFlag: string;

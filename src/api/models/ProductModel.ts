...
import { BeforeInsert, Column, Entity, BeforeUpdate, PrimaryGeneratedColumn, OneToMany, OneToOne, JoinColumn, ManyToOne } from 'typeorm';
...
export class Product extends BaseModel {
    ...
    @Column({ name: 'product_size_color' })
    public productSizeColor: string;  
    
    @Column({ name: 'promotion_flag' })
    public promotionFlag: number; 
    ...
    @Column({ name: 'promotion_product_y_id' })
    public promotionProductYid: number;   
    
    @Column({ name: 'promotion_free_product_price' })
    public promotionFreeProductPrice: number;   
    
    @Column({ name: 'promotion_product_y_slug' })
    public promotionProductYSlug: number;    
    ...
    public inventorySync: number;

    @ManyToOne(type => Manufacturer, manufacturer => manufacturer.product)
